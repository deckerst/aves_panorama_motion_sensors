...
class AccelerometerEvent {
  ...
  AccelerometerEvent.fromList(List<double> list) : x = list[0], y = list[1], z = list[2];
...
class MagnetometerEvent {
  ...
  MagnetometerEvent.fromList(List<double> list) : x = list[0], y = list[1], z = list[2];
...
class UserAccelerometerEvent {
  ...
  UserAccelerometerEvent.fromList(List<double> list) : x = list[0], y = list[1], z = list[2];
...
class OrientationEvent {
  ...
  OrientationEvent.fromList(List<double> list) : yaw = list[0], pitch = list[1], roll = list[2];
...
class AbsoluteOrientationEvent {
  ...
  AbsoluteOrientationEvent.fromList(List<double> list) : yaw = list[0], pitch = list[1], roll = list[2];
...
class MotionSensors {
  ...
  set accelerometerUpdateInterval(int interval) => setSensorUpdateInterval(typeAccelerometer, interval);

  /// The update interval of magnetometer. The units are in microseconds.
  set magnetometerUpdateInterval(int interval) => setSensorUpdateInterval(typeMagneticField, interval);
  ...
  set userAccelerometerUpdateInterval(int interval) => setSensorUpdateInterval(typeUserAccelerometer, interval);
  ...
  set absoluteOrientationUpdateInterval(int interval) => setSensorUpdateInterval(typeAbsoluteOrientation, interval);
